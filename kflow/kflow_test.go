...
func TestAddNodes(t *testing.T) {
	...
	node4 := NewMetaFlowNodeWithStringDependence("B1", []string{"A1"}, func(ctx context.Context, state State, plan *Plan) error { fmt.Println("B1"); return nil })
	node5 := NewMetaFlowNodeWithStringDependence("B2", []string{"A2"}, func(ctx context.Context, state State, plan *Plan) error { fmt.Println("B1"); return nil })
