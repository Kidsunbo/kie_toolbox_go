...
var SafeRun = flag{id: 3}         // If the node execution panic, it will not affect the entire flow execution, rather the panic will be recovered and the error will be returned.
